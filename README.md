...
- $\hat{d}_{\mathrm{local}} = 1 - \cos(\mathrm{norm}(\ell_{\mathrm{ref}}),\,\mathrm{norm}(\ell_{\mathrm{var}}))$
...
local 거리: $\hat{d}_{\mathrm{local}} = 1 - \cos(\mathrm{norm}(\ell_{\mathrm{ref}}),\,\mathrm{norm}(\ell_{\mathrm{var}}))$
